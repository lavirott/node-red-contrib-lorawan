...
LoRaWAN.prototype.initRN2483 = function () {
	...
	var cmds_sequence = me.init_sequence_p2p;
...
LoRaWAN.prototype._initSerial = function () {
	...
	this.init_sequence_p2p = [
		'mac pause',
		'radio set pwr ' + this.config.modeP2P_radioPwr,
		'radio set freq ' + this.config.modeP2P_radioFreq,
		'radio set sf ' + this.config.modeP2P_radioSf,
		'radio set cr ' + this.config.modeP2P_radioCr,
		'radio set bw ' + this.config.modeP2P_radioBw,
		'radio set crc ' + this.config.modeP2P_radioCRC
	];
